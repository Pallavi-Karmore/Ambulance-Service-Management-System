    ...
    <nav>
      ...
      <div class="logo"><a href="#"><i class="fa-solid fa-truck-medical fa-2x"></i> Med+</a></div>
        <ul class="links">
          ...
          <li><a href="search-ambulance.jsp">Search-Ambulence</a></li>
		<li><a href="view-ambulances.jsp">View Ambulances</a><li>
		<li><a href="ambulance-status.jsp">Booking Ambulance Status</a></li>
		<li><a href="user-feedback-complaints.jsp">Feedback/Complaints</a></li>
